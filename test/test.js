...
test( 'watch a single file -- of size 0', function ( t ) {
  t.timeoutAfter( 7500 )

  prepareTestFiles( function () {
    var filepath = path.join( __dirname, 'tmp', 'size-0-file.js' )
...
test( 'cover MITERU_LOGLEVEL full', function ( t ) {
  ...
  prepareTestFiles( function () {
    ...
    var expected = [
      ...
      'ENOENT',
      'module.exports = 777',
      'FILE WILL READ CONTENT   : ' + filepath,
      'FILE WILL COMPARE CONTENT   : ' + filepath,
      'HOT file: ' + filepath,
      'init: ' + filepath,
      'init: ' + filepath,
      'result: 777',
...
test( 'cover MITERU_LOGLEVEL dev', function ( t ) {
  ...
  prepareTestFiles( function () {
    ...
    var expected = [
      ...
      '== 12 ==',
      'init: ' + filepath,
      'init evt -- sizeChanged true, mtimeChanged false, fileContentHasChanged false: [' + filepath + ']',
      '== 13 ==',
      'init: ' + filepath,
      'result: 777',
      '== fs.stat:ing ==',
